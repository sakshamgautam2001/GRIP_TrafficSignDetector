# -*- coding: utf-8 -*-
'''MAking the Trained Model and Saving it'''
# Importing MatplotLib package
import matplotlib
matplotlib.use("Agg")

# import the necessary packages
from pyimagesearch.trafficSignDetector import signDetector
...
#Loading and Analyzing the given data
...
model = signDetector.build(width=32, height=32, depth=3, classes=numLabels)
